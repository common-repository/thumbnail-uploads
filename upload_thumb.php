<?php
/*
Plugin Name: Thumbnail Upload
Plugin URI: http://www.elschpa.de
Description: Thumbnail Upload is a simple HTML5 drag and drop thumbnail upload plugin to replace the default created thumbnails with your own thumbnails.
Version: 1.0.0
Author: elschpa
